...
namespace StrategyDesignPattern4
{
    ...
    public class RebateSettlement : SettlementAbstract
    {
        ...
        public RebateSettlement(string conditionMoney, string retrunMoney)
        {
            this.conditionMoney = Convert.ToDouble(conditionMoney);
            this.retrunMoney = Convert.ToDouble(retrunMoney);
        }
