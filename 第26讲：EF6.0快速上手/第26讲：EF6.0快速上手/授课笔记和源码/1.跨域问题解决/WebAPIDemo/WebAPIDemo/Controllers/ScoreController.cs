...
namespace WebAPIDemo.Controllers
{
    ...
    public class ScoreController : ApiController
    {
        ...
        //【9】基于服务器调用WebAPI（用的winform程序）

        //【10】put请求（put请求主要用于对象的更新，用法和post请求相同，也就会支持[FromBody]、dynamic）
        
        [Route("PutStudent")]
        [HttpPut]
        public Models.Student PutStudent()
        {
            //在这里编写其他逻辑...

            return new Student { StudentId = 1000, StudentName = "putty" };
        }
        //【11】Delete请求，主要用于删除操作，使用机制和Post相同...
        [Route("DeleteStudent")]
        [HttpDelete]
        public string DeleteStudent(Models.Student student)
        {
            //在这里编写其他逻辑...

            return $"删除的学员信息：{student.StudentId}  {student.StudentName}";
        }
