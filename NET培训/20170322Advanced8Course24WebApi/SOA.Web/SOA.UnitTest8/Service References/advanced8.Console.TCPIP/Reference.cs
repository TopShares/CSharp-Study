...
namespace SOA.UnitTest8.advanced8.Console.TCPIP {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="advanced8.Console.TCPIP.IMathService")]
    public interface IMathService {
        ...
        SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser GetUser(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/GetUser", ReplyAction="http://tempuri.org/IMathService/GetUserResponse")]
        System.Threading.Tasks.Task<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser> GetUserAsync(int x, int y);
        ...
        System.Collections.Generic.List<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser> UserList();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/UserList", ReplyAction="http://tempuri.org/IMathService/UserListResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser>> UserListAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMathServiceChannel : SOA.UnitTest8.advanced8.Console.TCPIP.IMathService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MathServiceClient : System.ServiceModel.ClientBase<SOA.UnitTest8.advanced8.Console.TCPIP.IMathService>, SOA.UnitTest8.advanced8.Console.TCPIP.IMathService {
        ...
        public SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser GetUser(int x, int y) {
            return base.Channel.GetUser(x, y);
        }
        
        public System.Threading.Tasks.Task<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser> GetUserAsync(int x, int y) {
            return base.Channel.GetUserAsync(x, y);
        }
        
        public System.Collections.Generic.List<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser> UserList() {
            return base.Channel.UserList();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<SOA.UnitTest8.advanced8.Console.TCPIP.WCFUser>> UserListAsync() {
